'''
    Ref: https://community.khronos.org/t/color-tables/22518/3
    Rrom: nexusone
    Posted: March 2002
'''
...
Navy = NavyBlue = (0.137255, 0.137255, 0.556863)
Orange = (1, 0.5, 0.0)
...
colors = [color for color in globals().values() if isinstance(color, tuple) and len(color) == 3]
